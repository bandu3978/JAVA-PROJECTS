		...
		switch(sc.nextInt())
		  {
			case 1: {
				...
				System.out.println("chicken biriyani ordered "+qty1+" plate\n-----------------------------------------------------");
			}break;
			case 2:  {
				...
				System.out.println("chicken tandoori ordered "+qty2+" plate\n-----------------------------------------------------");
			}break;
			case 3:  {
				f=false;
 ...
 void veg() {
	 ...
	 switch(sc.nextInt())
		 ...
		 case 1:	{
			 ...
			 System.out.println("dose ordered "+qty3+" plate\n-----------------------------------------------------");
		 }break;
		 case 2: {
			 ...
			 System.out.println("Veg biriyani ordered "+qty4+" plate\n-----------------------------------------------------");
		 }break;
		 case 3: {
			 ...
			 System.out.println("Idly-vada ordered "+qty5+" plate\n-----------------------------------------------------");
		 }break;
		 case 4:	{
			 f=false;
